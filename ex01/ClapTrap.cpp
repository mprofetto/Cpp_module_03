...
/*   Updated: 2023/08/07 15:20:01 by mprofett         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name) :
	...
	_attack_damages(0)
{
	std::cout << "A new ClapTrap has been created with following parameters: " << std::endl;
...
void		ClapTrap::set_hits_points(const int hp)
{
	this->_hit_points = hp;
}

void		ClapTrap::set_hits_points_max(const int hp)
{
	this->_hit_points_max = hp;
}

void		ClapTrap::set_energy_points(const int ep)
{
	this->_energy_points = ep;
}

void		ClapTrap::set_attack_damages(const int att)
{
	this->_attack_damages = att;
}
